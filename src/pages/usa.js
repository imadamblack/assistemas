  ...
  return (
    <>
      <section
        ...
        <div className="w-full lg:w-1/2 text-center text-white z-10 p-8">
          ...
          <div className="flex flex-col justify-center items-center mt-12">
            <p className="ft-2 font-medium text-center mb-12 text-white">Programa una sesión gratuita <br/>para diseñar el software de gestión de tu compañía</p>
            <Link href="#contact">
              <a
                onClick={() => setLastClick('hero')}
                className="button mb-4 mx-auto"
              >Programa una sesión estratégica</a>
            </Link>
          </div>
        </div>
      ...
      <section className="reading-container mb-16">
        ...
        <p className="ft-4 font-bold">Queremos que te conviertas en una compañía</p>
        ...
        <p className="ft-2 mt-12">
          ...
          en la compañía tenga la información y todos colapsen cuando esa
          ...
          importa: que la compañía crezca.
        </p>
      ...
      <section className="reading-container my-16">
        <p className="ft-2">
          Creo que estamos de acuerdo en parar el uso excesivo de excel.
          <br/><br/>
          Por eso, te comparto 3 razones de por qué un software a medida:
        </p>
        <h3 className="ft-2 font-bold text-brand-3">
          La automatización
        </h3>
        <p className="ft-2">
          No puedes negar que encargar siempre las mismas tareas y no salgan como quieres, se vuelve un dolor diario.
        </p>
        <h3 className="ft-2 font-bold text-brand-3">
          La integración y centralización de información
        </h3>
        <p className="ft-2">
          Para que no tengas que depender de una persona cuando se va de vacaciones y no te pueda resolver.
        </p>
        <h3 className="ft-2 font-bold text-brand-3">
        ...
        <p className="ft-2">
          ...
          que no les tome toda una semana generar un reporte que puede estar listo en 2 clics.
        </p>
        <div>
          <Link href="#contact">
            <a
          ...
          <p className="-ft-2 !mt-2 text-center">Programa una asesoría de software</p>
        </div>
      </section>

      <Blockbuster
        overhead="Por qué AS Sistemas"
        title="Más que una agencia de software: somos especialistas en gestión de procesos compañíariales"
        image={i02}
      />
      <section className="reading-container my-16">
        <p className="ft-2">
        ...
        <ol className="!mt-0">
          <li className="ft-1 mb-4"><b>Diagnóstico</b> de necesidades de la compañía</li>
          ...
          <li className="ft-1 mb-4">También incluimos <b>soporte técnico</b> por si a alguien se le olvida como
            funcionaba algo
          </li>
        </ol>
        <p className="ft-2">
      ...
      <Blockbuster
        ...
        title={`¿Ya buscas librarte de la excelitis?<br/> Entonces sí hacemos match`}
        image={i03}
      />
      <section className="reading-container my-16">
        <p className="ft-2">
          ...
          <br/><br/>
          Desde hoy es importante saber que esta es una inversión y
          <b>un software</b> en AS Sistemas va <b>desde los $7,500 USD</b>, según las
          necesidades de tu compañía.
          <br/><br/>
          Además, quédate tranquilo de que no vamos a venderte algo que no necesitas, tampoco vamos a agregar cargos extras.
        </p>
        <div>
          <Link href="#contact">
            <a
      ...
      >
        <div className="reading-container !py-20">
          ...
          <p className="text-white">
            Regálanos unos datos y programa una cita para analizar tu proyecto.
          </p>
          <OptInForm
            lastClick={lastClick}
          />
